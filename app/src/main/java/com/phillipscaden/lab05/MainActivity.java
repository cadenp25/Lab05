package com.phillipscaden.lab05;
...
public class MainActivity extends AppCompatActivity {
    ...
    TextView set1, onCreate1, onCreate2, onStart1, onStart2, onResume1, onResume2, onPause1, onPause2, onStop1, onStop2, onRestart1, onRestart2, onDestroy1, onDestroy2;
    Counter counter;
    TextView set2;
    Button button;
    int count;
